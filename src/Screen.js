...
const Screen=(props)=>{
    ...
    <>
        <MenuScreen>
            ...
            {props.activePage==="Home"?<><Heading>Ipod</Heading><Home activeList={props.activeList}/></>:null}
            
            {props.activePage==="Music"?<><Heading>Ipod</Heading><Music activeList={props.activeList}/></>:null}
